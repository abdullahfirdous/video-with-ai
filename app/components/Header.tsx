...
import { Home, User, ChevronDown, Upload, LogOut, LogIn, UserCircle } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header className="border-b border-gray-700 fixed top-0 left-0 right-0 z-[9999] shadow-lg" style={{backgroundColor: '#1F2937'}}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            {/* Upload Button - only show when user is logged in */}
            {session && (
              <Link
                href="/upload"
